...
export default function Edititem() {
    ...
    const fetchitemData = async () => {
        try {
            ...
            const response = await fetch(`https://roofing-31jz.onrender.com/api/getitems/${itemId}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://roofing-31jz.onrender.com/api/updateitemdata/${itemId}`, {
                method: 'POST',
                headers: {
